...
@section('content')
    <div class="container-fluid p-4">
        <h2 class="heading-2 mb-4">Tambah Kategori Lowongan Kerja</h2>
    ...
    @push('scripts')
        <script>
            $(document).ready(function() {
                ...
                // // Validate if tags are selected before submitting
                ...
                //             icon: 'error',
                //             title: 'Peringatan!',
                //             text: 'Semua tag lowongan kerja sudah terpakai. Silahkan buat tag baru atau lanjut menambahkan data kategori lo',
                //         });
                //     }
                // });
            });
