...
@section('content')
    <div class="container-fluid p-4">
        ...
        <h2 class="heading-2-primary">Konsultasi Karir</h2>
            ...
            <table id="datatable" class="table table-bordered custom-border w-100 mt-3">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="sub-heading text-center">{{ \Carbon\Carbon::parse($jadwal->tanggal)->translatedFormat('d F Y') }}</td>
                        <td class="sub-heading text-center">{{ \Carbon\Carbon::parse($jadwal->jam)->format('H:i') }} WIB</td>
                    </tr>
                    @endforeach
                </tbody>
                {{-- <tfoot>
