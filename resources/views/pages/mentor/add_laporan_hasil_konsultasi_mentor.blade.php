...
@section('content')
    <div class="container-fluid p-4">
        <h2 class="heading-2 mb-4">Tambah Laporan Hasil Konsultasi</h2>
        ...
        <!-- Create Form -->
        <form action="{{ route('store_laporan_hasil_konsultasi_mentor') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <!-- Left Column -->
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control custom-border" id="nama_maxians" name="nama_maxians"
                            placeholder="Masukkan nama maxians" value="{{ old('nama_maxians') }}" required>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control custom-border" id="komentar" name="komentar" placeholder="Masukkan komentar"
                            rows="3" required>{{ old('komentar') }}</textarea>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="image-preview-container mb-2">
                            <img id="imagePreview" src="{{ asset('images/profile-placeholder.jpg') }}"
                                ...
                                alt="Preview Foto Bukti Konsultasi">
                        </div>
                        <input type="file" class="form-control custom-border" id="bukti_konsultasi"
                            name="bukti_konsultasi" accept=".jpg,.jpeg,.png,.pdf" required>
