...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
    <div class="app-wrapper">
        @include('partials.partials_mentor.navbar')
        @include('partials.partials_mentor.sidebar')
        ...
        @include('partials.partials_mentor.footer')
    </div>
 ...
 @endif --}}
    ...
    <script src='/vendor/fullcalendar/locales/id.js'></script>
