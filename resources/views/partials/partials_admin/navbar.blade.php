        ...
        <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item dropdown user-menu">
                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="{{ asset('images/admin.jpg') }}" class="user-image rounded-circle shadow"
                        alt="User Image">
                    <span class="d-none d-md-inline">Maxy academy</span>
                </a>
                <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end rounded-5">
                    <li class="user-header text-bg-primary rounded-top-5">
                        <img src="{{ asset('images/admin.jpg') }}" class="rounded-circle shadow" alt="User Image">
                        <p>
                            Maxy academy - Company relationship
